...
//    this.draw(scene);
    ...
    draw(scene) {
        ...
        this.textObj1 = scene.add.text(rect.x + rect.width / 2, rect.y + rect.height, this.text1, {
            fontSize: "100px",
            color: "#000000"
        ...
        this.textObj2 = scene.add.text(rect2.x + rect2.width / 2, rect2.y + rect2.height, this.text2, {
            fontSize: "100px",
            color: "#000000"
        }).setOrigin(0.5, 1).setDepth(100);
